...
layout(location = 3) out uint outVertexId;
...
void main() {
    ...
    Vertex inVertex = vertex[gl_VertexIndex];
    //gl_Position =  vec4(abs(inVertex.inPosition), 1.0);
    ...
    outColor.rgb = mix(vec3(1,169,51)/255, vec3(255,0,5)/255, inVertex.inRadius);
